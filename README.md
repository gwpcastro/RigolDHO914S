...
As shown above, the image was taken using my personal computer with the same data. We can clearly see the differences between both. It doesn't seem to be influenced by system response,  considering those resembling ripples are persistent.
